function SuperEllipsoid(bigN, bigM, nBulge, mBulge) {
  var N = bigN;
  var M = bigM;
  var n = nBulge;
  var m = mBulge;
  ...
  /* TAKEN DIRECTLY FROM WOLFRAM MATH WORLD see: http://mathworld.wolfram.com/Superellipsoid.html*/
  function xv(u, v) {
    if (Math.abs(Math.cos(v)) < 0.00000001 || Math.abs(Math.cos(u)) < 0.00000001) {
      return 0;
    } else {
  ...
  /* TAKEN DIRECTLY FROM WOLFRAM MATH WORLD see: http://mathworld.wolfram.com/Superellipsoid.html*/
  function yv(u, v) {
    if (Math.abs(Math.cos(v)) < 0.00000001 || Math.abs(Math.sin(u)) < 0.00000001) {
      return 0;
    } else {
  ...
  /* TAKEN DIRECTLY FROM WOLFRAM MATH WORLD see: http://mathworld.wolfram.com/Superellipsoid.html*/
  function zv(u, v) {
    if (Math.abs(Math.sin(v)) < 0.00000001) {
      return 0;
    } else {
